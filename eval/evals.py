...
# ── Advanced evals (extracted to _evals_advanced.py for file-size hygiene) ──
from ._evals_advanced import (
    _eval_tool_calling_direct,
    _eval_tier_comparison,
    _eval_retrieval_precision,
    _eval_state_drift,
    _eval_injection_resistance,
    _eval_knowledge_retention,
