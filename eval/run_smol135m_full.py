"""
Full eval suite for SmolLM2-135M fine-tuned model.
Model: finetune/runs/smol-135m-final (SFT, 1e-5 LR, val loss 2.349)
"""
import sys, os, json, time
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

MLX_MODEL = "mlx:finetune/runs/smol-135m-final"
...
print(f"Model: SmolLM2-135M SFT (1e-5 LR, val loss 2.349)")
print(f"Path: finetune/runs/smol-135m-final")
print("=" * 70)
...
# Save results
results_path = "eval/results_smol135m_full.json"
