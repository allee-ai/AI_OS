...
The central nervous system — builds Nola's awareness before each response.
...
You don't interact with this directly — it works automatically to make Nola's responses more personalized.
