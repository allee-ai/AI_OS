...
Linking Core provides three comprehensive scoring functions that power all relevance calculations in Nola:
...
**Example**:
```python
from Nola.threads.linking_core.adapter import score_threads
...
**Example**:
```python
from Nola.threads.linking_core.adapter import score_relevance
...
**Example**:
```python
from Nola.threads.linking_core.adapter import score_facts_multidimensional
...
The consolidation daemon (`Nola/services/consolidation_daemon.py`) integrates with linking_core:
