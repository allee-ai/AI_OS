"""
Stringify Nola - Collect all .md files and combine into a single string.
"""
...
def stringify_nola(root_dir: str = None, output_dir: str = None) -> str:
    """
...
"""
    ...
    nola_string = f"""# Nola Documentation - Combined String
