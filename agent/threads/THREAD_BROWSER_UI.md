...
The front-end calls backend endpoints for thread summaries, module lists, and key-level CRUD. See `agent/services/api.py` endpoints for `introspection/threads/*`.
